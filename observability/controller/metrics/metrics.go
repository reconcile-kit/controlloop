...
var (
	// ReconcileTotal is a prometheus counter observability which holds the total
	...
	// ReconcileErrors is a prometheus counter observability which holds the total
	...
	// ReconcilePanics is a prometheus counter observability which holds the total
...
func init() {
	registry.Registry.MustRegister(
		...
		WorkerCount,
		ActiveWorkers,
		// expose process observability like CPU, Memory, file descriptor usage etc.
		collectors.NewProcessCollector(collectors.ProcessCollectorOpts{}),
		// expose Go runtime observability like GC stats, memory stats etc.
