...
func init() {
	registry.Registry.MustRegister(depth)
	registry.Registry.MustRegister(adds)
	registry.Registry.MustRegister(latency)
	registry.Registry.MustRegister(workDuration)
	registry.Registry.MustRegister(unfinished)
	registry.Registry.MustRegister(longestRunningProcessor)
	registry.Registry.MustRegister(retries)
